// try_emplace02.cpp : 此文件包含 "main" 函数。程序执行将在此处开始并结束。
//
...
int main()
{
	...
	// 906106643 是用户id
	onDoubleClickFriendItem3(906106643);
}
